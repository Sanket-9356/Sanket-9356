...
Built **SQL Mentor**, a Discord bot with Python, Postgres, Docker, RailWay Cloud with **400+ real-time SQL interview questions**, allowing users to practice SQL by topic, company, or difficulty level.
